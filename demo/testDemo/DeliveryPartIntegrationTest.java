...
public class DeliveryPartIntegrationTest {
	 private final static String COOK_INPUT = "src/demo/core/cook.txt";
		...
		public void test23() throws Exception {
			...
			String expectedresult="delivery:[[PorkwithCornDumpling, PorkwithCornDumpling, FriedMeatWithChili, RoastedDuck] ] deliverer: Alice scheduled deliver time: 21:43delivery:[[FriedMeatWithChili, RoastedDuck, PorkwithCornDumpling, RoastedDuck] , [RoastedDuck, FriedMeatWithChili, PorkwithCornDumpling, RoastedDuck] ] deliverer: Bob scheduled deliver time: 21:53";
			assertEquals(expectedresult, Runner.getDelivery(COOK_INPUT,DISH_INPUT, DELIVERER_INPUT, ORDER_INPUT));
		}
		...
		public void test25() throws Exception {
			...
			String expectedresult="delivery:[[PorkwithCornDumpling, PorkwithCornDumpling, PorkwithCornDumpling] ] deliverer: Alice scheduled deliver time: 17:15delivery:[[RoastedDuck, FriedMeatWithChili] ] deliverer: Bob scheduled deliver time: 17:21delivery:[[PorkwithCornDumpling] ] deliverer: Kitty scheduled deliver time: 17:31delivery:[[RoastedDuck] ] deliverer: Alice scheduled deliver time: 17:35delivery:[[RoastedDuck, PorkwithCornDumpling] ] deliverer: Bob scheduled deliver time: 17:35";
			assertEquals(expectedresult, Runner.getDelivery(COOK_INPUT,DISH_INPUT, DELIVERER_INPUT, ORDER_INPUT));
		}
		...
		public void test26() throws Exception {
			...
			String expectedresult="delivery:[[PorkwithCornDumpling] ] deliverer: Alice scheduled deliver time: 19:09delivery:[[FriedMeatWithChili] , [RoastedDuck, PorkwithCornDumpling] ] deliverer: Bob scheduled deliver time: 19:46delivery:[[FriedMeatWithChili] ] deliverer: Kitty scheduled deliver time: 20:09delivery:[[PorkwithCornDumpling, RoastedDuck] ] deliverer: Alice scheduled deliver time: 21:52";
			assertEquals(expectedresult, Runner.getDelivery(COOK_INPUT,DISH_INPUT, DELIVERER_INPUT, ORDER_INPUT));
		}
		...
		public void test28() throws Exception {
			...
			String expectedresult="delivery:[[PorkwithCornDumpling, RoastedDuck, FriedMeatWithChili] , [FriedMeatWithChili, RoastedDuck, RoastedDuck] ] deliverer: Alice scheduled deliver time: 16:49delivery:[[PorkwithCornDumpling, FriedMeatWithChili] ] deliverer: Bob scheduled deliver time: 18:45";
			assertEquals(expectedresult, Runner.getDelivery(COOK_INPUT,DISH_INPUT, DELIVERER_INPUT, ORDER_INPUT));
		}
		...
		public void test39() throws Exception {
			...
			String expectedresult="delivery:[[FriedMeatWithChili] , [RoastedDuck] , [PorkwithCornDumpling] ] deliverer: Alice scheduled deliver time: 13:24delivery:[[PorkwithCornDumpling] , [RoastedDuck] , [RoastedDuck] ] deliverer: Bob scheduled deliver time: 13:32";
			assertEquals(expectedresult,  Runner.getDelivery(COOK_INPUT,DISH_INPUT, DELIVERER_INPUT, ORDER_INPUT));
		}
